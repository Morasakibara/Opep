...
/**
undefined
 * Route: /reproduction/rejoindre-opep-inscription-agence
 */
export default function RejoindreOpepInscriptionAgenceReproductionPage() {
...
<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full opacity-5 pointer-events-none" style={{"backgroundImage":"radial-gradient(#79d8b7 1px, transparent 1px)","backgroundSize":"40px 40px"}}></div>
</div>
...
<div>
<p className="font-title-md text-title-md">Agency Identity</p>
...
<input className="bg-surface-dim border-charcoal-border rounded-lg text-on-surface focus:ring-primary focus:border-primary px-4 py-3" placeholder="e.g. Finexs Voyages" type="text"/>
</div>
<div className="flex flex-col gap-2">
<label className="font-label-caps text-label-caps text-on-surface-variant">REGISTRATION NUMBER / NO. D'IMMATRICULATION</label>
<input className="bg-surface-dim border-charcoal-border rounded-lg text-on-surface focus:ring-primary focus:border-primary px-4 py-3" placeholder="RCCM-..." type="text"/>
</div>
...
<div className="flex flex-wrap gap-2 p-3 bg-surface-dim border border-charcoal-border rounded-lg">
<span className="bg-primary/20 text-primary px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1">Douala <span className="material-symbols-outlined text-[14px] cursor-pointer">close</span></span>
<span className="bg-primary/20 text-primary px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1">Yaoundé <span className="material-symbols-outlined text-[14px] cursor-pointer">close</span></span>
<span className="bg-primary/20 text-primary px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1">Bafoussam <span className="material-symbols-outlined text-[14px] cursor-pointer">close</span></span>
...
<input className="bg-surface-dim border-charcoal-border rounded-lg text-on-surface focus:ring-primary focus:border-primary px-4 py-3" placeholder="admin@agency.cm" type="email"/>
</div>
<div className="flex flex-col gap-2">
...
<input className="w-full bg-surface-dim border-charcoal-border rounded-r-lg text-on-surface focus:ring-primary focus:border-primary px-4 py-3" placeholder="6..." type="tel"/>
</div>
</div>
</div>
<button className="w-full bg-primary text-on-primary font-title-md py-4 rounded-xl hover:opacity-90 transition-all flex items-center justify-center gap-2" onClick={() => setCurrentStep(prev => Math.min(prev + 1, 3))} type="button">
...
<div className="relative group border-2 border-charcoal-border rounded-2xl p-6 bg-surface-container-low hover:border-primary transition-all cursor-pointer flex flex-col h-full" onClick={() => setSelectedPlan('basic')}>
...
<div className="w-full py-3 rounded-lg border border-charcoal-border group-hover:bg-primary/10 group-hover:border-primary text-center transition-colors font-semibold">Select Basic</div>
</div>

<div className="relative group border-2 border-primary rounded-2xl p-6 bg-primary/5 hover:shadow-[0_0_30px_rgba(121,216,183,0.1)] transition-all cursor-pointer flex flex-col h-full" onClick={() => setSelectedPlan('premium')}>
<div className="absolute top-4 right-4 opacity-100" id="check-premium">
<span className="material-symbols-outlined text-primary" style={{"fontVariationSettings":"'FILL' 1"}}>check_circle</span>
</div>
<div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-primary text-on-primary px-4 py-1 rounded-full font-label-caps text-label-caps">RECOMMENDED</div>
...
<div className="w-full py-3 rounded-lg bg-primary text-on-primary text-center transition-colors font-semibold">Select Premium</div>
</div>
</div>
<button className="w-full bg-primary text-on-primary font-title-md py-4 rounded-xl hover:opacity-90 transition-all flex items-center justify-center gap-2 mt-4" onClick={() => setCurrentStep(prev => Math.min(prev + 1, 3))} type="button">
...
<input className="rounded bg-surface-dim border-charcoal-border text-primary focus:ring-primary h-5 w-5" id="terms" type="checkbox"/>
...
<div className="mt-8 flex flex-wrap justify-between items-center gap-6 opacity-60">
<div className="flex items-center gap-2">
<span className="material-symbols-outlined text-primary">verified</span>
<span className="font-label-caps text-label-caps">ENCRYPTED DATA PORTAL</span>
</div>
<div className="flex items-center gap-2">
<span className="material-symbols-outlined text-primary">support_agent</span>
<span className="font-label-caps text-label-caps">DEDICATED AGENCY SUPPORT</span>
</div>
<div className="flex items-center gap-2">
<span className="material-symbols-outlined text-primary">account_balance_wallet</span>
<span className="font-label-caps text-label-caps">SEAMLESS FCFA PAYOUTS</span>
</div>
</div>
</div>
</div>
      ...
      <Modal
        ...
        description="Your agency registration is being processed. Our team will contact you within 24-48 hours for document verification."
      >
        <div className="flex flex-col items-center text-center gap-6">
          <div className="w-20 h-20 bg-success-green/20 rounded-full flex items-center justify-center mx-auto">
          ...
          <button className="w-full bg-primary text-on-primary font-title-md py-4 rounded-xl hover:opacity-90" onClick={() => setSuccessModal(false)}>Return to Portal</button>
        </div>
      </Modal>
    </div>
  );

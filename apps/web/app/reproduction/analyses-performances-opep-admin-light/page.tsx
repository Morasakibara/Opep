...
/**
undefined
 * Route: /reproduction/analyses-performances-opep-admin-light
 */
export default function AnalysesPerformancesOpepAdminLightReproductionPage() {
  ...
  return (
    <div className="min-h-screen bg-[#111316] text-[#e2e2e6] overflow-x-hidden">
      ...
      <header className="flex justify-between items-center px-margin-desktop w-full sticky top-0 z-40 bg-surface h-16 border-b border-charcoal-border">
<div className="flex items-center gap-4">
<span className="font-headline-lg text-headline-lg font-bold text-primary">OPEP Portal</span>
<div className="hidden md:flex items-center bg-surface-variant px-4 py-2 rounded-full border border-charcoal-border ml-8 w-64">
...
<img className="w-full h-full object-cover" data-alt="A professional studio portrait of a Super Admin for a logistics platform" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDatEYNhbwbj2NQ-gGZ6wkLaIo9Y09f7YL9oWgGkXw4BWkRPcGjFioomXHm9RiE3OvOaCQJynUp-96-yZU07Hf0r3lIeRAsgREROFCzYGY-0TT__gZMSCCeQQweYdCaMCZRd8qrcvosEmzZXrmQjMNzZvnxJJ-O7N0nj3psYnXK0gyMfH_JIxDQOp_KS-jxk8O-zg_Y-nd1Dc8uBXTQxCZMv68V0CaOQo_uejGREdVhoz6u-2XLDX-6Zd3GayQELBjPQOpVUbEONoo"/>
</div>
</div>
</header>
<div className="flex flex-1 overflow-hidden">

<aside className="hidden md:flex flex-col h-full w-[280px] bg-white border-r border-charcoal-border p-gutter gap-unit overflow-y-auto custom-scrollbar">
...
<div>
<div className="font-headline-lg text-[20px] font-bold text-on-surface">OPEP Admin</div>
<div className="text-label-caps font-label-caps text-on-surface-variant">Management Portal</div>
</div>
</div>
<nav className="flex flex-col gap-1">
<a className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:bg-surface-variant hover:text-on-surface transition-all rounded-lg" href="#">
...
<a className="flex items-center gap-3 px-4 py-3 bg-primary-container text-primary font-semibold rounded-lg transition-all" href="#">
<span className="material-symbols-outlined">monitoring</span>
<span className="font-label-caps text-label-caps">Analytics</span>
</a>
</nav>
<button className="mt-6 mx-2 bg-primary text-white py-3 rounded-lg font-bold flex items-center justify-center gap-2 active:scale-95 transition-transform shadow-md">
<span className="material-symbols-outlined">add</span>
                New Trip
            </button>
<div className="mt-auto pt-6 flex flex-col gap-1">
<a className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:bg-surface-variant transition-all rounded-lg" href="#">
<span className="material-symbols-outlined">help</span>
<span className="font-label-caps text-label-caps">Help Center</span>
</a>
<a className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:bg-red-50 transition-all rounded-lg" href="#">
...
{(tripsError || driversError) && (
  <div className="mx-6 mt-4">
    <ErrorState title="Erreur de connexion" message={String(tripsError?.message || driversError?.message || '')} onRetry={() => { tripsRefetch(); driversRefetch() }} />
  </div>
)}
...
<div className="flex items-center gap-2 bg-white p-1 rounded-xl border border-charcoal-border">
<button className="px-4 py-2 bg-primary text-white rounded-lg text-label-caps font-label-caps">Mensuel</button>
...
<button className="mt-6 w-full border border-charcoal-border py-2 text-label-caps font-label-caps rounded-lg hover:bg-surface-variant transition-colors text-on-surface-variant">
                        Voir tout le réseau
                    </button>
</div>
</div>
...
<div className="p-6 border-b border-charcoal-border flex items-center justify-between bg-white">
...
<thead className="bg-surface-variant text-on-surface-variant text-label-caps font-label-caps">
<tr>
...
<tr className="hover:bg-surface-variant/50 transition-colors cursor-pointer">
<td className="px-6 py-4">
<div className="flex items-center gap-3">
<div className="w-8 h-8 rounded bg-primary-container flex items-center justify-center text-primary font-bold">G</div>
...
<td className="px-6 py-4">
<div className="flex items-center gap-3">
<div className="w-8 h-8 rounded bg-tertiary-container flex items-center justify-center text-tertiary font-bold">F</div>
...
<td className="px-6 py-4">
<div className="flex items-center gap-3">
<div className="w-8 h-8 rounded bg-secondary-container flex items-center justify-center text-secondary font-bold">T</div>
...
<span className="text-on-surface font-medium">62%</span>
</div>
<div className="flex items-center justify-between text-body-sm">
<div className="flex items-center gap-2">
